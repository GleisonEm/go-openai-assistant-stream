# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/gleisonem/go-openai-assistant-stream.svg)](https://pkg.go.dev/github.com/gleisonem/go-openai-assistant-stream)
[![Go Report Card](https://goreportcard.com/badge/github.com/gleisonem/go-openai-assistant-stream)](https://goreportcard.com/report/github.com/gleisonem/go-openai-assistant-stream)
...
```
go get github.com/gleisonem/go-openai-assistant-stream
```
...
See also: https://pkg.go.dev/github.com/gleisonem/go-openai-assistant-stream#ClientConfig
</details>
...
**Related Issues:**
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/gleisonem/go-openai-assistant-stream/issues/9)
...
**Related Issues:**
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/gleisonem/go-openai-assistant-stream/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/gleisonem/go-openai-assistant-stream/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/gleisonem/go-openai-assistant-stream/graphs/contributors) and sponsors of this project:
